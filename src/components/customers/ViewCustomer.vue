  ...
  <v-app>
    ...
    <div>
      ...
      <v-content>
        ...
        <v-container grid-list-lg  class="default_card">
          <v-layout row wrap>
            <v-flex lg4>
              <v-card>
              ...
              <v-card>
                ...
                <v-list dense class="pukulist">
                  <v-list-tile v-for="customerrecord in customerrecords" :key="customerrecord.id">
                    <v-list-tile-content>{{customerrecord.timestamp}} {{customerrecord.text}}</v-list-tile-content>
              ...
              <v-card>
                ...
                <v-list dense class="pukulist">
                  <v-list-tile v-for="customerSalesRecord in customerSalesRecords" :key="customerSalesRecord.id">
                    <v-list-tile-content>{{customerSalesRecord.item}} {{customerSalesRecord.timestamp}}</v-list-tile-content>
                  </v-list-tile>
                </v-list>
              </v-card>
            </v-flex>
