        ...
        <template v-for="item in items">
          ...
          >
            ...
            >
              ...
              <v-list-tile-content>
                <v-list-tile-title>
                  <router-link :to="{ name: child.link, params: {} }">
                    {{ child.text }}
                  </router-link>
                </v-list-tile-title>
              </v-list-tile-content>
    ...
    <v-toolbar
     ...
     >
      <v-toolbar-title style="width: 300px" class="ml-0 pl-3">
        ...
        <span class="hidden-sm-and-down">Easy Business Manager</span>
      </v-toolbar-title>
      <v-text-field
        flat
        solo-inverted
  ...
  data(){
      return{
        ...
        items: [
          ...
          { icon: 'assignment', text: 'Task' , link:'Task' },
...
<style scoped>
  ...
  .application .theme--light.list, .theme--light .list{
    border:0px solid #2e3f5b!important;
  }
</style>
