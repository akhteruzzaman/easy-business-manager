        ...
        >
          <v-layout row wrap>
            <v-flex xs12 sm12 md3 lg3>
              ...
              <v-card flat style="background:#424242!important;color:#FFF!important;padding:20px;">
                <h1>Contacted</h1>
                <div>
            ...
            <v-flex xs12 sm12 md3 lg3>
              <router-link :to="{ name: 'LeadsType', params: {type:'Qualified'}}">
                <v-card style="background:#424242!important;color:#FFF!important;padding:20px;">
                  <h1>Qualified</h1>
                  <div>
