    ...
    <div>
      <v-content>
        <v-container grid-list-lg>
          <v-layout row wrap>
            <v-flex lg6  class="pukulist expense_report">
              <div class="px-4" style="background:#424242;">
              <h1>Expenses of {{current_month_name}}</h1>
              <v-divider></v-divider>
              <v-list dense>
                <v-list-tile>
            ...
            <v-flex lg6 >         
              <v-flex lg12 class="px-4" style="background:#424242!important;color:#FFF!important;">
                <div>
                  <h1 style="border-bottom:1px solid #757575;">Expense of {{current_month_name}}</h1>
                  <h4 class="py-2">Total Expense Of This Month : {{expenses_total}} {{currency}}</h4>
                </div>
                <v-btn class="default_button" :to="{name: 'Expenses'}">Check All Expenses</v-btn>
              </v-flex>
              <v-flex lg12 class="px-4 mt-4" style="background:#424242!important;color:#FFF!important;">
