        ...
        <form @submit.prevent="editExpense">
          <v-container grid-list-sm class="pa-4">
            <v-layout row wrap>
              ...
              <v-flex xs10>
                <h4 style="color:#FFF!important;" v-if="expense.expense_type">Expense Type: {{expense.expense_type.expense_type}}</h4>
                <v-select
                  prepend-icon="group"
                  :items="expense_types"
              ...
              <v-flex xs10>
                <v-btn type="submit" block class="default_button">Update Expense</v-btn>
              </v-flex>
            </v-layout>
          </v-container>
        </form>
