...
export default {
  ...
  computed:{
        ...
        pieChart(){
          ...
          return 'conic-gradient(#606060 '+salesPercentage+'%,#C7C7C7 '+expensePercentage+'%)';
        }       
  },
  created(){
...
.box .skill .graph{
  ...
  background:#606060;
  box-shadow: 1px -1px #616161, 2px -2px #C7C7C7, 3px -3px #C7C7C7,   4px -4px #C7C7C7, 5px -5px #C7C7C7, 6px -6px #C7C7C7, 7px -7px   #C7C7C7, 8px -8px #C7C7C7, 9px -9px #C7C7C7, 10px -10px #C7C7C7;
