...
.navigation-drawer>.list .list__tile:hover{
    background:#515151;
}
...
.elevation-1 {
     -webkit-box-shadow: 0 2px 1px -1px transparent,0 1px 1px 0 transparent,0 1px 3px 0 transparent!important; 
    box-shadow: 0 2px 1px -1px transparent,0 1px 1px 0 transparent,0 1px 3px 0 transparent!important; 
}

.show_customers .application .theme--light.input-group:not(.input-group--error):not(.input-group--focused):not(.input-group--disabled) .input-group__input .input-group__append-icon:not(:hover), .application .theme--light.input-group:not(.input-group--error):not(.input-group--focused):not(.input-group--disabled) .input-group__input .input-group__prepend-icon:not(:hover), .theme--light .input-group:not(.input-group--error):not(.input-group--focused):not(.input-group--disabled) .input-group__input .input-group__append-icon:not(:hover), .theme--light .input-group:not(.input-group--error):not(.input-group--focused):not(.input-group--disabled) .input-group__input .input-group__prepend-icon:not(:hover) {
    color:rgb(243,243,243,0.4)!important;
}

.show_customers .application .theme--light.input-group input, .application .theme--light.input-group textarea, .theme--light .input-group input, .theme--light .input-group textarea {
    color: #FFF!important;
}
.show_customers .application .theme--light.table, .theme--light .table {
    background:#303030!important;
    color: #FFF!important;
    border:1px solid transparent;
}

.show_customers .application .theme--light.datatable .datatable__actions, .theme--light .datatable .datatable__actions {
    background-color: transparent;
    color:#FFF!important;
    border-top: 1px solid transparent!important;
}

.show_customers .application .theme--light.table thead th, .theme--light .table thead th {
    color:#FFF!important;
}

.sales_report .list__tile {
    padding:0!important;
  }

  .expense_report .list__tile {
    padding:0!important;
  }

.application .theme--light.date-picker-table th, .theme--light .date-picker-table th {
    color:#FFF!important;
}

.show_customers .application .theme--light.datatable .datatable__actions__select .input-group--select .input-group__append-icon, .application .theme--light.datatable .datatable__actions__select .input-group--select .input-group__selections__comma, .theme--light .datatable .datatable__actions__select .input-group--select .input-group__append-icon, .theme--light .datatable .datatable__actions__select .input-group--select .input-group__selections__comma {
    color:#FFF!important;
}


.application .theme--light.icon.icon--disabled:not(.input-group__append-icon), .theme--light .icon.icon--disabled:not(.input-group__append-icon) {
    color:#FFF!important;
}

.application .theme--light.data-iterator .data-iterator__actions, .theme--light .data-iterator .data-iterator__actions {
    color: #FFF!important;
}

.show_customers .application .theme--light.table thead tr:first-child, .theme--light .table thead tr:first-child {
    border-bottom: 1px solid #757575!important;
}

.show_customers .application .theme--light.table tbody tr:not(:last-child), .theme--light .table tbody tr:hover {
    background-color:#515151!important;
}

.show_customers .application .theme--light.table tbody tr:not(:last-child), .theme--light .table tbody tr:not(:last-child) {
    border-bottom: 1px solid #757575!important;
}

.show_customers .primary {
    background: #241633!important;
    border-color: #757575 !important;
}

.add_customer .primary {
    background: #241633!important;
    border-color: #757575 !important;
}

.edit_customer .primary {
    background: #241633!important;
    border-color: #757575 !important;
}
...
.pagination__item--active{
    background-color: #241633 !important;
}
.application .theme--light.input-group.input-group--dirty .input-group__selections__comma:not(.input-group__selections__comma--active), .theme--light .input-group.input-group--dirty .input-group__selections__comma:not(.input-group__selections__comma--active) {
    color:rgb(243,243,243,0.4)!important;
}
...
.application .theme--light.btn.btn--disabled, .application .theme--light.btn.btn--disabled .icon, .theme--light .btn.btn--disabled, .theme--light .btn.btn--disabled .icon {
    color:#FFF!important;
}
.application .theme--light.list, .theme--light .list{
...
.picker__body .btn__content {
    color: #FFF!important;
}
.application .theme--light.date-picker-header .date-picker-header__value:not(.date-picker-header__value--disabled) strong:not(:hover), .theme--light .date-picker-header .date-picker-header__value:not(.date-picker-header__value--disabled) strong:not(:hover) {
    color:#FFF!important;
}
.picker .primary {
